...
import stylesCss from 'themes/vaadincourse/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_vaadincourse_componentCss']) {
    
    document['_vaadintheme_vaadincourse_componentCss'] = true;
  }
